...
const (
	...
	MsgID_SESSION_INVALIDATE MsgID = 1010 // SessionSvr → All Gateways: player reconnected elsewhere
	// ===== service discovery
	MsgID_SERVICE_HELLO MsgID = 1009 // Backend → Caller: announce handled msgIDs
)
...
const file_msgid_proto_rawDesc = "" +
	"\n" +
	"\vmsgid.proto\x12\x02pb*\xda\x04\n" +
	"\x05MsgID\x12\x16\n" +
	...
	"\x13SESSION_RECONNECTED\x10\xf0\a\x12\x17\n" +
	"\x12SESSION_INVALIDATE\x10\xf2\a\x12\x12\n" +
	"\rSERVICE_HELLO\x10\xf1\aB\x15Z\x13cardwar/protocol/pbb\x06proto3"
